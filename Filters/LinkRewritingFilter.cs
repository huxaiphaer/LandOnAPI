...
namespace App.Filters
{
    public class LinkRewritingFilter : IAsyncResultFilter
    {
        ...
        public Task OnResultExecutionAsync(ResultExecutingContext context,
         ResultExecutionDelegate next)
        {
            ...
            var rewrite = new LinkRewriter(_urlHelperFactory.GetUrlHelper(context));
            RewriteAllLinks(asObjectResult.Value, rewrite);
        ...
        public static void RewriteAllLinks(object model, LinkRewriter rewriter)
        {
            ...
            var objectsPRoperties = allProperties
                .Except(linkProperties)
                .Except(arrayProperties);

            RewriteLinksInNestedObjects(objectsPRoperties, model, rewriter);
